...
class PathListStruct(AmigaStruct):
    _format = [("PathList#", "pl_Next"), ("FileLock#", "pl_Lock")]
...
class AssignListStruct(AmigaStruct):
    _format = [("AssignList*", "al_Next"), ("BPTR", "al_Lock")]
...
class CSourceStruct(AmigaStruct):
    _format = [("UBYTE*", "CS_Buffer"), ("LONG", "CS_Length"), ("LONG", "CS_CurChr")]
...
class PathStruct(AmigaStruct):
    _format = [("BPTR", "path_Next"), ("BPTR", "path_Lock")]
