...
class MinNodeStruct(AmigaStruct):
    _format = [("MinNode*", "mln_Succ"), ("MinNode*", "mln_Pred")]
...
class IntVectorStruct(AmigaStruct):
    _format = [("APTR", "iv_Data"), ("VOIDFUNC", "iv_Code"), ("Node*", "iv_Node")]


# SoftIntList
@AmigaStructDef
class SoftIntListStruct(AmigaStruct):
    _format = [("List", "sh_List"), ("UWORD", "sh_Pad")]
...
class StackSwapStruct(AmigaStruct):
    _format = [("APTR", "stk_Lower"), ("ULONG", "stk_Upper"), ("APTR", "stk_Pointer")]


# Semaphores
@AmigaStructDef
class SemaphoreRequestStruct(AmigaStruct):
    _format = [("MinNode", "sr_Link"), ("Task*", "sr_Waiter")]
...
class MemChunkStruct(AmigaStruct):
    _format = [("MemChunk*", "mc_Next"), ("ULONG", "mc_Bytes")]
